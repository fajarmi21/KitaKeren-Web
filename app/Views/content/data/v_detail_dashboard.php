...
<script type="text/javascript">
    ...
    function event_buku() {
        ...
        $(".edit-data").click(function(e) {
            id = $(this).data('id');
            $.ajax({
                    url: '<?= site_url('master/read_detail_dashboard/single') ?>',
                    type: 'GET',
                    dataType: 'json',
                    data: {
                        id: id
                ...
                .done(function(data) {
                    $("#form-edit input[name='id_detail_dashboard']").val(data[0].id_detailDashboard);
                    $("#form-edit input[name='ind']").val(data[0].nama_detailDashboard.ind);
                    $("#form-edit input[name='en']").val(data[0].nama_detailDashboard.en);
                    $("#form-edit img[id='blahE']").attr('src', '<?php base_url() ?>/' + data[0].icon_detailDashboard);
        ...
        $(".hapus-data").click(function(e) {
            ...
            if (confirm("Anda yakin?")) {
                $.ajax({
                        url: '<?= site_url('master/write_detail_dashboard/delete') ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: {
                            id: id
    ...
    $("#form-tambah").submit(function(e) {
        ...
        if (document.getElementById("imgInp").files.length == 0) {
            ...
            $.ajax({
                    url: '<?= site_url('master/write_detail_dashboard/insert') ?>',
                    type: 'POST',
                    dataType: 'json',
    ...
    $("#form-edit").submit(function(e) {
        ...
        form = $(this);
        $.ajax({
                url: '<?= site_url('master/write_detail_dashboard/update') ?>',
                type: 'POST',
                dataType: 'json',
                data: new FormData(this),
                processData: false,
