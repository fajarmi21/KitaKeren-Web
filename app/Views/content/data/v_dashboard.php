    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form-edit" enctype="multipart/form-data">
                <div class="modal-body">
                    <input type="hidden" name="id_dashboard" class="form-control">
                    <div class="row">
                        <label class="col-md-4 control-label">Name</label>
                        <div class="col-sm-12">
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    function refresh_buku() {
        $.ajax({
                url: '<?= site_url('master/read_dashboard/show/dashboard/pagination') ?>',
                type: 'GET',
                dataType: 'json',
                data: read_buku,
            })
            .done(function(data) {
                ...
                $.ajax({
                        url: '<?= site_url('master/read_dashboard/show/dashboard') ?>',
                        type: 'GET',
                        dataType: 'html',
                        data: read_buku,
                    })
    ...
    function refresh_detail_dashboard() {
        $.ajax({
                url: '<?= site_url('master/read_detail_dashboard/show/detail_dashboard/pagination') ?>',
                type: 'GET',
                dataType: 'json',
                data: read_buku,
            })
            .done(function(data) {
                ...
                $("#filter-page").attr('data-original-title', 'Halaman Maksimum: ' + data.total_page);
                $.ajax({
                        url: '<?= site_url('master/read_detail_dashboard/show/detail_dashboard') ?>',
                        type: 'GET',
                        dataType: 'html',
                        data: read_buku,
                    })
    ...
    function event_buku() {
        ...
        $(".edit-data").click(function(e) {
            id = $(this).data('id');
            $.ajax({
                    url: '<?= site_url('master/read_dashboard/single') ?>',
                    type: 'GET',
                    dataType: 'json',
                    data: {
                        id: id
                ...
                .done(function(data) {
                    $("#form-edit input[name='id_dashboard']").val(data[0].id_dashboard);
                    $("#form-edit input[name='ind']").val(data[0].nama_dashboard.ind);
                    $("#form-edit input[name='en']").val(data[0].nama_dashboard.en);
                    $("#form-edit img[id='blahE']").attr('src', '<?php base_url() ?>/' + data[0].icon_dashboard);
        ...
        $(".hapus-data").click(function(e) {
            ...
            if (confirm("Anda yakin?")) {
                $.ajax({
                        url: '<?= site_url('master/write_dashboard/delete') ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: {
                            id: id
    ...
    $("#form-tambah").submit(function(e) {
        ...
        if (document.getElementById("imgInp").files.length == 0) {
            ...
            $.ajax({
                    url: '<?= site_url('master/write_dashboard/insert') ?>',
                    type: 'POST',
                    dataType: 'json',
    ...
    $("#form-edit").submit(function(e) {
        ...
        form = $(this);
        $.ajax({
                url: '<?= site_url('master/write_dashboard/update') ?>',
                type: 'POST',
                dataType: 'json',
                data: new FormData(this),
                processData: false,
